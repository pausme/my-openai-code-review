...
import com.huang.middleware.sdk.domain.model.ChatCompletionRequest;
import com.huang.middleware.sdk.domain.model.ChatCompletionSyncResponse;
import com.alibaba.fastjson2.JSON;
import com.huang.middleware.sdk.domain.model.Message;
import com.huang.middleware.sdk.domain.model.Model;
...
public class OpenAiCodeReview {
    ...
    private static void pushMessage(String logUrl) {
        ...
        message.setTemplate_id("0dBfC8flXQ3WLRoWGG0yfy13bHoCA-rZxJJRZ0DMGDs");
    ...
    private static String writeLog(String token, String log) throws Exception {
        Git git = Git.cloneRepository()
                .setURI("https://github.com/pausme/my-openai-code-review-log.git")
        ...
        return "https://github.com/pausme/my-openai-code-review-log" + dateFolderName + "/" + fileName;
    }
